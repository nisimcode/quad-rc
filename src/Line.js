  ...
  return (
    <div style={{ paddingTop: 20 }}>
      <input name={`field-${props.pr}1`} maxLength="1" value={plc1} type="text" disabled={props.tries !== props.pr}
             style={{width: '12%', fontSize: 25, textAlign: "center", margin: 2, backgroundColor: clr1}}
      ...
      <input name={`field-${props.pr}2`} maxLength="1" value={plc2} type="text" disabled={props.tries !== props.pr}
             style={{width: '12%', fontSize: 25, textAlign: "center", margin: 2, backgroundColor: clr2}}
              onClick={() => setPlc2("")}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}3`} maxLength="1" value={plc3} type="text" disabled={props.tries !== props.pr}
             style={{width: '12%', fontSize: 25, textAlign: "center", margin: 2, backgroundColor: clr3}}
              onClick={() => setPlc3("")}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}4`} maxLength="1" value={plc4} type="text" disabled={props.tries !== props.pr}
             style={{width: '12%', fontSize: 25, textAlign: "center", margin: 2, backgroundColor: clr4}}
             onClick={() => setPlc4("")}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}5`} maxLength="1" value={plc5} type="text" disabled={props.tries !== props.pr}
             style={{width: '12%', fontSize: 25, textAlign: "center", margin: 2, backgroundColor: clr5}}
              onClick={() => setPlc5("")}
             onChange={(e) => {
