  ...
  return (
    <div style={{ paddingTop: 30 }}>
      <input name={`field-${props.pr}1`} maxLength="1" value={pl1} type="text"
             style={{width: '10%', fontSize: 35, textAlign: "center", margin: 2, backgroundColor: cl1}}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}2`} maxLength="1" value={pl2} type="text"
             style={{width: '10%', fontSize: 35, textAlign: "center", margin: 2, backgroundColor: cl2}}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}3`} maxLength="1" value={pl3} type="text"
             style={{width: '10%', fontSize: 35, textAlign: "center", margin: 2, backgroundColor: cl3}}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}4`} maxLength="1" value={pl4} type="text"
             style={{width: '10%', fontSize: 35, textAlign: "center", margin: 2, backgroundColor: cl4}}
             onChange={(e) => {
      ...
      <input name={`field-${props.pr}5`} maxLength="1" value={pl5} type="text"
             style={{width: '10%', fontSize: 35, textAlign: "center", margin: 2, backgroundColor: cl5}}
             onChange={(e) => {
